...
<br><br>
<a href="http://127.0.0.1:8000/mail-verify?code={{ $email_data['verification_code'] }}">Click
    Here!</a>
...
<body>
    ...
    <div style="height: 600px;  text-align:center; margin-top: 6rem">
        <div style="padding: 0 auto; ">
            ...
            <a href="http://127.0.0.1:8000/mail-verify?code={{ $email_data['verification_code'] }}">
                <button
